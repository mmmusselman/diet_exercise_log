...
response.subtitle = T('simple analysis for your health!')

## read more at http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'Matt Musselman <matt@slugly.com>'
response.meta.description = 'A diet/exercise log'
response.meta.keywords = 'diet, exercise, log'
...
response.menu = [['Home', True, URL('index')],
                 ['Menu', False, URL('menu')],
                 ['View Logs', False, URL('view_logs')],
                 ['Settings', False, URL('settings')]]
